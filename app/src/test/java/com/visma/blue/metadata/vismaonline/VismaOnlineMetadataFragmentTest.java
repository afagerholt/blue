...
public class VismaOnlineMetadataFragmentTest extends BaseMetaDataFragmentTest{

    private static final int ACTIVITY_REQUEST_CODE_RETRIEVE_QR_CODE = 1;

    @Override
    public void setup() {
        BlueConfig.setAppId(AppId.VISMA_ONLINE.getValue());
        super.setup();
    }
    ...
    public void testViewCreation() {
        View rootView = mMetaDataFragment.getView();
        assertNotNull("Root view in VismaOnlineMetadaFragment is null!",
                rootView);
        assertNotNull("Information text view in VismaOnlineMetadaFragment is null!",
                rootView.findViewById(R.id.metaDataInformationTextView));
        assertNotNull("Type layout in VismaOnlineMetadaFragment is null!",
                rootView.findViewById(R.id.layoutType));
        assertNotNull("Type text view in VismaOnlineMetadaFragment is null!",
                rootView.findViewById(R.id.typeTextView));
        assertNotNull("Payed layout view in VismaOnlineMetadaFragment is null!",
                rootView.findViewById(R.id.blue_fragment_metadata_layout_payed));
        assertNotNull("Payed layout checkbox in VismaOnlineMetadaFragment  is null!",
                rootView.findViewById(R.id.blue_fragment_metadata_payed_checkbox));
        assertNotNull("Payment layout view in VismaOnlineMetadaFragment is null!",
                rootView.findViewById(R.id.blue_fragment_metadata_layout_payment_date));
        assertNotNull("Payment text view in VismaOnlineMetadaFragment is null!",
                rootView.findViewById(R.id.blue_fragment_payment_date_data));
        assertNotNull("Image layout view in VismaOnlineMetadaFragment is null!",
                rootView.findViewById(R.id.fragment_metadata_layout_image));
        assertNotNull("Image file name text view in VismaOnlineMetadaFragment is null!",
                rootView.findViewById(R.id.fragment_metadata_image_filename));
        assertNotNull("More information layout view in VismaOnlineMetadaFragment is null!",
                rootView.findViewById(R.id.fragment_metadata_layout_more_information));
        assertNotNull("More information expand iamge view in VismaOnlineMetadaFragment is null!",
                rootView.findViewById(R.id
                        .fragment_metadata_layout_more_information_expander_image));
        assertNotNull("More information text view in VismaOnlineMetadaFragment is null!",
                rootView.findViewById(R.id.fragment_metadata_layout_more_information_text));
        assertNotNull("More information expand layout view in VismaOnlineMetadaFragment is null!",
                rootView.findViewById(R.id
                        .fragment_metadata_layout_more_information_expandable_view));
        assertNotNull("Organisation number layout view in VismaOnlineMetadaFragment is null!",
                rootView.findViewById(R.id.activity_more_information_layout_organisation_number));
        assertNotNull("Organisation number text view in VismaOnlineMetadaFragment is null!",
                rootView.findViewById(R.id.activity_more_information_organisation_number));
        assertNotNull("Name layout view in VismaOnlineMetadaFragment is null!",
                rootView.findViewById(R.id.activity_more_information_layout_information_name));
        assertNotNull("Name text view in VismaOnlineMetadaFragment is null!",
                rootView.findViewById(R.id.activity_more_information_name));
        assertNotNull("Reference number layout view in VismaOnlineMetadaFragment is null!",
                rootView.findViewById(R.id.activity_more_information_layout_reference_number));
        assertNotNull("Reference number text view in VismaOnlineMetadaFragment is null!",
                rootView.findViewById(R.id.activity_more_information_reference_number));
        assertNotNull("Invoice date layout view in VismaOnlineMetadaFragment is null!",
                rootView.findViewById(R.id.activity_more_information_layout_invoice_date));
        assertNotNull("Invoice date text view in VismaOnlineMetadaFragment is null!",
                rootView.findViewById(R.id.activity_more_information_layout_invoice_date_data));
        assertNotNull("Due date layout view in VismaOnlineMetadaFragment is null!",
                rootView.findViewById(R.id.activity_more_information_layout_due_date));
        assertNotNull("Due layout view in VismaOnlineMetadaFragment is null!",
                rootView.findViewById(R.id.activity_more_information_layout_due_date_data));
        assertNotNull("Due amount text view in VismaOnlineMetadaFragment is null!",
                rootView.findViewById(R.id.activity_more_information_due_amount));
        assertNotNull("Total vat layout view in VismaOnlineMetadaFragment is null!",
                rootView.findViewById(R.id.activity_more_information_layout_total_vat));
        assertNotNull("Total vat amount text view in VismaOnlineMetadaFragment is null!",
                rootView.findViewById(R.id.activity_more_information_total_vat_amount));
        assertNotNull("High vat layout view in VismaOnlineMetadaFragment is null!",
                rootView.findViewById(R.id.activity_more_information_layout_high_vat));
        assertNotNull("High vat amount text view in VismaOnlineMetadaFragment is null!",
                rootView.findViewById(R.id.activity_more_information_high_vat_amount));
        assertNotNull("Middle vat layout view in VismaOnlineMetadaFragment is null!",
                rootView.findViewById(R.id.activity_more_information_layout_middle_vat));
        assertNotNull("Middle vat amount text view in VismaOnlineMetadaFragment is null!",
                rootView.findViewById(R.id.activity_more_information_middle_vat_amount));
        assertNotNull("Low vat layout view in VismaOnlineMetadaFragment is null!",
                rootView.findViewById(R.id.activity_more_information_layout_low_vat));
        assertNotNull("Low vat amount text view in VismaOnlineMetadaFragment is null!",
                rootView.findViewById(R.id.activity_more_information_low_vat_amount));
        assertNotNull("Currency spinner view in VismaOnlineMetadaFragment is null!",
                rootView.findViewById(R.id.activity_more_information_currency_spinner));
        assertNotNull("Comment text view in VismaOnlineMetadaFragment is null!",
    ...
    public void testViewDisablingWhenPhotoLocked() {
        ...
        assertFalse("Currency spinner is not disabled!",
                rootView.findViewById(R.id.activity_more_information_currency_spinner)
                        .isEnabled());
        assertFalse("Comment text view in VismaOnlineMetadaFragment is null!",
